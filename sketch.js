...
function draw() {
 ...
 if(gameState === "rules"){
    ...
    stroke("black")
   fill("black")
   text("Story:There is a small family of husband, wife and son.The man's name is John.He is a police officer.His wife's name is Ruby",20,100)
   text("and his son's name is Alex.Today's is Alex's birthday and he has been kidnapped by some zombies and kept in an island. ",50,150)
   text("His father has gone to the island to save his son.So can you help John to save his son.Let us Find out",50,200)
